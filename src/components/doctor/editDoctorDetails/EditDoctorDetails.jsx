...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctorapp-backend-gilt.vercel.app/`+doctorDetails.profile_image} alt='doctor'></img></div>
