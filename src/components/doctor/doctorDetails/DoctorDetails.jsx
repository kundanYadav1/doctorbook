...
const DoctorDetails = () => {
    ...
    return (
        <div className='doctordetails'>
            <div className='doctorimage'><img className='doctorprofileimage' src={`https://doctor-appointment-24yh.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
