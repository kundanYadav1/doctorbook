...
const EditAdminDetails = () => {
    ...
    const getUserData = async () => {
        try {
            ...
            setAdminDetails(response.data.userData);
        } catch (error) {
    ...
    return (
        <div className='editadmindetails'>
            ...
            <input
                className='adminlabelinputprofile'
                type="file"
                accept=".jpg, .jpeg, .png"
            ...
            <div className='editadmindata'>
                <div className='editadmindataleft'>
                    <div className='editadminlabel'>
                        Name <input type='text' className='adminlabelinput' name="name" id='l1' value={adminDetails.name} onChange={onChange} disabled />
                    </div>
                    <div className='editadminlabel'>
                        Email <input type='email' className='adminlabelinput' name="email" id='l1' value={adminDetails.email} onChange={onChange} disabled />
                    </div>
                    <div className='editadminlabel'>
                        Role <input type='text' className='adminlabelinput' name="role" id='l1' value={adminDetails.role} onChange={onChange} disabled />
                    </div>
                    <div className='editadminlabel'>
                        Gender <input type='text' className='adminlabelinput' name="gender" id='l1' value={adminDetails.gender} onChange={onChange} />
                    </div>
                    <div className='editadminlabel'>
                        DOB <input type='date' className='adminlabelinput' name="dob" id='l1' value={adminDetails.dob} onChange={onChange} />
                    </div>
                    <button className='editadminprofileupdate' onClick={handleUpdate}>Update</button>
                </div>
                <div className='editadmindataright'>
                    <div className='editadminlabel'>
                        Phone <input type='number' className='adminlabelinput' name="phone" id='l1' value={adminDetails.phone} onChange={onChange} />
                    </div>
                    <div className='editadminlabel'>
                        Aadhar Number <input type='number' className='adminlabelinput' name="adhar_no" id='l1' value={adminDetails.adhar_no} onChange={onChange} />
                    </div>
                    <div className='editadminlabel'>
                        Father's Name <input type='text' className='adminlabelinput' name="father_name" id='l1' value={adminDetails.father_name} onChange={onChange} />
                    </div>
                    <div className='editadminlabel'>
                        Mother's Name <input type='text' className='adminlabelinput' name="mother_name" id='l1' value={adminDetails.mother_name} onChange={onChange} />
                    </div>
                    <div className='editadminlabel'>
                        Marital Status <input type='text' className='adminlabelinput' name="marital_status" id='l1' value={adminDetails.marital_status} onChange={onChange} />
                    </div>
                </div>
            </div>
        </div>
