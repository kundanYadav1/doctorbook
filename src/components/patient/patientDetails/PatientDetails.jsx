...
const PatientDetails = () => {
    ...
    return (
        <div className='patientdetails'>
            <div className='patientimage'><img className='patientprofileimage' src={`https://doctorapp-backend-gilt.vercel.app/` + patientDetails.profile_image} alt='patient'></img></div>
