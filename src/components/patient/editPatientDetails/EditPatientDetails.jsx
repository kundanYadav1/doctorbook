...
const EditPatientDetails = () => {
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`https://doctor-appointment-24yh.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
